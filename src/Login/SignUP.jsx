                    ...
                    <div class="card-body p-md-5 mx-md-4">
                      ...
                      <form>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="password" id="form2Example13" class="form-control" placeholder="Password"/>
                            
                         </div>

                         <div class="form-outline mb-4">
                            <input type="password" id="form2Example14" class="form-control" placeholder="Confirm Password"/>
